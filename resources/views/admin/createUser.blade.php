    ...
    <form method="POST" id="form" action="{{url('admin/crear-user')}}">
        ...
        <div class="form-row">
            ...
            <div class="form-group col-md-6">
                ...
                <span class="text-danger">*</span>
                <input type="password" class="form-control" id="inputPassword" name="password" placeholder="1 Caracter especial, mayusculas y números" required>
            ...
            <div class="form-group col-md-6">
                ...
                <span class="text-danger">*</span>
                <select name="inputState" id="states" class="form-control select2">
            ...
            <div class="form-group col-md-6">
                ...
                <span class="text-danger">*</span>
                <select name="city_id" id="ciudades" class="form-control select2" require>
	...
	id_country.select2().on('change', function() {
	    $.ajax({
	        ...
	        success:function(data) {
	            ...
	            id_state.empty();
                id_ciudades.empty();
                id_state.append($("<option></option>").attr("value", "").text('Seleccione...')); 
    ...
    id_state.select2().on('change', function() {
	    $.ajax({
	        ...
	        success:function(data) {
	        	console.log(data);
	            id_ciudades.empty();
                id_ciudades.append($("<option></option>").attr("value", "").text('Seleccione...')); 
	            $.each(data.data, function(index, item) {
